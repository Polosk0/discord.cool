...
main() {
    while true; do
        ...
        case $choice in
            ...
            12) get_attack_params "rapid-zero" && launch_l7_attack "rapid-zero" ;;
            13) get_attack_params "rapid-zero-priv" && launch_l7_attack "rapid-zero-priv" ;;
            14) get_attack_params "vhold" && launch_l7_attack "vhold" ;;
            15) get_attack_params "vholdv2" && launch_l7_attack "vholdv2" ;;
            16) get_attack_params "zero" && launch_l7_attack "zero" ;;
            17) get_attack_params "zero-bypass" && launch_l7_attack "zero-bypass" ;;
            18) get_attack_params "zero-rst" && launch_l7_attack "zero-rst" ;;
            19) get_attack_params "zero-rstgeo" && launch_l7_attack "zero-rstgeo" ;;
            20) get_attack_params "zerov2" && launch_l7_attack "zerov2" ;;
