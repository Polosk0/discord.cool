...
show_menu() {
    ...
    echo -e "${WHITE}╠══════════════════════════════════════════════════════════════════════╣${NC}"
    echo -e "${WHITE}║${NC} ${CYAN}LAYER 7 (HTTP/HTTPS) ATTACKS - Optimized Methods:${NC}                  ${WHITE}║${NC}"
    ...
    echo -e "${WHITE}║${NC}  ${YELLOW}[12]${NC} rapid-zero       - HTTP/2/3 Flood (Chrome/Firefox)              ${WHITE}║${NC}"
    echo -e "${WHITE}║${NC}  ${YELLOW}[13]${NC} rapid-zero-priv  - Rapid Zero Private                          ${WHITE}║${NC}"
    echo -e "${WHITE}║${NC}  ${YELLOW}[14]${NC} vhold            - Method for Holding Sites (Max 10 conc)       ${WHITE}║${NC}"
    echo -e "${WHITE}║${NC}  ${YELLOW}[15]${NC} vholdv2          - VHold V2 (Enhanced)                         ${WHITE}║${NC}"
    echo -e "${WHITE}║${NC}  ${YELLOW}[16]${NC} zero             - HTTP/2 Flooder (Ratelimit)                  ${WHITE}║${NC}"
    echo -e "${WHITE}║${NC}  ${YELLOW}[17]${NC} zero-bypass      - Bypassing All Sites (No Request Capture)    ${WHITE}║${NC}"
    echo -e "${WHITE}║${NC}  ${YELLOW}[18]${NC} zero-rst         - Zero RST (Cloudflare Custom Rule Bypass)    ${WHITE}║${NC}"
    echo -e "${WHITE}║${NC}  ${YELLOW}[19]${NC} zero-rstgeo      - Zero RST Geo                                 ${WHITE}║${NC}"
    echo -e "${WHITE}║${NC}  ${YELLOW}[20]${NC} zerov2           - HTTP/2 Flooder (Ratelimit Bypass)            ${WHITE}║${NC}"
    echo -e "${WHITE}║${NC}                                                                  ${WHITE}║${NC}"
    echo -e "${WHITE}╠══════════════════════════════════════════════════════════════════════╣${NC}"
